...
class Products extends Component {
    ...
    render() {
        ...
        <div className="Item carousel-container2">
            <h3>Boots</h3>
        </div>
        <Carousel swipeable={true} draggable={true} showDots={true} responsive={responsive} ssr={true}
            // means to render carousel on server-side.
            infinite={true} autoPlay={this.props.deviceType !== "mobile"
                ? false
                : false} autoPlaySpeed={1000} keyBoardControl={true} customTransition="ease all 1s" transitionDuration={500} containerClass="carousel-container2" removeArrowOnDeviceType={["tablet", "mobile"]} deviceType={this.props.deviceType} dotListClass="custom-dot-list-style" itemClass="CarousalItem carousel-item-padding-40-px" partialVisbile={true}>
            <div className="Item">
                <Card
                    style={{
                        width: '18rem'
